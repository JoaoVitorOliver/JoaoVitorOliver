        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    Slug = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    LogoUrl = table.Column<string>(type: "TEXT", maxLength: 600, nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    SearchText = table.Column<string>(type: "TEXT", maxLength: 1300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalProductId = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clicks_Offers_ProductOfferId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceHistory_Offers_ProductOfferId",
                        column: x => x.ProductOfferId,
                        principalTable: "Offers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clicks_ProductOfferId_ClickedAt",
                table: "Clicks",
                columns: new[] { "ProductOfferId", "ClickedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Offers_CurrentPrice",
                table: "Offers",
                column: "CurrentPrice");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceHistory_ProductOfferId_CollectedAt",
                table: "PriceHistory",
                columns: new[] { "ProductOfferId", "CollectedAt" });
